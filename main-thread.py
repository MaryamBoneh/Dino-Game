import arcade, random, threading, cv2
...
class myThread(threading.Thread):
    def __init__(self, name, hreadLock):
...
class Game(arcade.Window, threading.Thread):
    def __init__(self):
        self.w = 900
        self.h = 400
        self.msec = 0
...
if __name__ == '__main__':
    ...
    # Create new threads
    thread_game = myThread(hreadLock, "game")
    thread_hand = myThread(hreadLock, "hand")
    ...
    threads.append(thread_game)
    threads.append(thread_hand)
